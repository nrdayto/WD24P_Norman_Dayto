        ...
        <?php include('top_menu.php'); ?> 
			...
			?>	
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-3 food-item">
					<form method="post" action="order_cart.php?action=add&id=<?php echo $item["id"]; ?>">
						...
						<div class="card rounded-0" align="center";>
							...
							<div class="card-body">
								<div class="lh-1">
									...
									<div><small class="card-description text-success h6 mb-0">$ <?php echo number_format($item["price"],2); ?></small></div>
									<div class="d-grid">
