...
if (isset($_SESSION["name"])) {
  ?>
<nav class="navbar navbar-expand-lg navbar-expand-md navbar-dark bg-gradient bg-success">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./order_cart.php"><span class="fa fa-shopping-cart"></span> Cart (<?php
